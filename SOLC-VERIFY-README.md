...
- `--modifies-analysis`: State variables and balances are checked for modifications only if there are modification annotations or if this flag is given.
